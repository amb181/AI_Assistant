...
- I need help with [Base Station Antennas](category_name)
- I need help with [Batteries](category_name)
- Who is the category manager for [Benefit Insurance](category_name)
- Who is the category manager for [Brand Royalties](category_name)
...
- Who is the manager for [EMS Repair](category_name)
...
- Who is the category manager for [Interconnect](category_name)
...
- Who is the manager for [Physical and Personal Security](category_name)
...
- Who is the category manager for [CBA SITE SERVICES INC](supplier_name)
...
- Who manages [MITEL COMMUNICATIONS INC](supplier_name)
